...
- アクセス元 ~ バージニア北部リージョン 間のレイテンシーが低ければバージニア北部の EC2 インスタンスにルーティングする
...
1. ホストゾーンにレイテンシールーティングの A レコードを作成する
    ...
    <img src="./img/Route53-Create-Latencybased-Routing_1.png" />
...
2. 正しくルーティングされるか確認する
    ...
    <img src="./img/Route53-Check-Latencybased-Routing_1.png" />
